...
This is the oblikovati-spacemouse add-in (module oblikovati.org/spacemouse),
...
pulled in solely by the add-in<->host integration tests. The repo is GPL-2.0-only
